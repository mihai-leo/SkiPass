...
public class DayInterface {
    ...
    protected void addPass()
    {
        ...
        else if(name.getText().isEmpty()||phoneNumber.getText().isEmpty()||days.getText().isEmpty())
        {
        ...
        else
        {
            try
            {
                ...
                else if (!stock.borrowSnowboard(sn)&&sn!=0)
                {
                    ...
                    DayPass pass = new DayPass(name.getText(), phoneNumber.getText(), LocalDate.now(), LocalDate.now(), Integer.parseInt(days.getText()), bSn, bSk, sn, sk);
                    pass.printPass();
