...
public class HourInterface {
    ...
    protected void addPass()
    {
        ...
        else if(name.getText().isEmpty()||phoneNumber.getText().isEmpty()||hours.getText().isEmpty())
        {
        ...
        else
        {
            try
            {
                ...
                else if (!stock.borrowSnowboard(sn)&&sn!=0)
                {
                    ...
                    HourPass pass = new HourPass(name.getText(), phoneNumber.getText(), LocalDate.now(), LocalTime.now(), Integer.parseInt(hours.getText()), bSn, bSk, sn, sk);
                    pass.printPass();
